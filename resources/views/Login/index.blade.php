...
<body>
  <header>
    ...
    <div>
      ...
      <form method="POST" id="login-form" class="row g-3 needs-validation" novalidate>
        <div class="col-auto">
          <label for="inputPassword2" class="visually-hidden">Login</label>
          <input name="login" type="text" class="form-control" id="inputText" placeholder="Digite seu usuario" required>
        ...
        <div class="col-auto">
          ...
          <input name="password" type="password" class="form-control" id="inputPassword2" placeholder="Digite sua senha" required>
          <div class="invalid-feedback">
            Informe seu senha
          </div>
        </div>
